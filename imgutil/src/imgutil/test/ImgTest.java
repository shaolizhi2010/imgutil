	...
	public static void main(String[] args) throws Exception {
		   ...
		   int imageWidth =  style.getWidth();// 300;//图片的宽度  
	        ...
	        {    
	            ...
	            List<String> list = DbcSbcUtils.split("利客修（likexiu.com）致力打造本地生活服务O2O的电商平台。利客修自身定位是连接“跟维修有关的一切。”其中包括：手机、电脑、房屋、疏通、开换锁、家电、家具、汽车、办公设备、手表、珠宝、鞋包服饰、乐器等相关维修。除了维修业务，利客修计划延伸安装、清洗、改造、回收等上门服务。"
	            ...
	            // graphics.drawString("网址:www.likexiu.com", style.getInt(style.padding_left) , 36);    
	            ImageIO.write(newimg, "jpg", new File("C:\\Users\\lizhi\\Desktop\\temp\\abc.gif"));//生成图片方法一     
